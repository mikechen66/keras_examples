...
We will map each character in the string to an integer for training the model. Similary, we will 
need to map the predictions of the model back to strings. For this purpose we will maintain two 
dictionaries, mapping characters to integers, and integers to characters, respectively.

## Inference

You can use the trained model [Hugging Face Hub](https://huggingface.co/keras-io/ocr-for-captcha)
...
data_dir = Path("/home/mike/datasets/captcha_images_v2/")
