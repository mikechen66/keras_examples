...
Let's plot the model accuracy and loss for the training and the validating set. Note no 
random seed is specified for this notebook. For your notebook, there might be slight 
variance. We see that the accuracy for our model is around 95%.

## Predict and evaluate results

# Evaluate the model on our test data!

We see that our accuracy on our test data is lower than the accuracy for our validating set. 
