...
It is a common practice to use the same input image resolution while training and testing vision 
models. However, as investigated in [Fixing the train-test resolution discrepancy]
...
def preprocess_initial(train, image_size):
    ...
    For training, do random_horizontal_flip -> random_crop. For val, 
    just resize. No color-jittering has been used.
    """
