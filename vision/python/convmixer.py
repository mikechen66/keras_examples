...
Vision Transformers (ViT[Dosovitskiy et al.](https://arxiv.org/abs/1612.00593)) extract small 
...
To keep run time short, we will train the model for only 10 epochs. To focus on the core ideas 
of ConvMixer, we will not use other training-specific elements like RandAugment ([Cubuk et al.]
...
The gap in training and validation performance can be mitigated by using additional regulari-
...
There's been a recent trend on fusing convolutions with other data-agnostic operations like self-
attention. Following works are along this line of research:
...
| Trained Model | Demo |
| :--: | :--: |
| [![Generic badge](https://img.shields.io/badge/🤗%20Model-ConvMixer-black.svg)]
(https://huggingface.co/keras-io/conv_Mixer) | 
[![Generic badge](https://img.shields.io/badge/🤗%20Spaces-ConvMixer-black.svg)]
(https://huggingface.co/spaces/keras-io/conv_Mixer) |
"""
...
# Print the indices of the convolution layers that are not
